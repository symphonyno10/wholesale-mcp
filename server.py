...
5. 결과 파싱 구조:
   - HTML: execute_js로 행 셀렉터, td 클래스, hidden div 확인
   - JSON: body_preview에서 items_path 확인 (배열이면 "", 객체면 "list" 등)
   - json_mapping: {"items_path": "경로", "fields": {"product_code": "키", ...}}
...
6. execute_js로 결과 테이블 구조 확인 (헤더: 일자, 제품명, 수량, 단가, 매출)
